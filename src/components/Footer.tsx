    ...
    <footer className="bg-gray-50 border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mt-4 text-gray-600 text-sm">
              Revolutionizing the interview process with AI-powered solutions for recruiters and candidates.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/testimonials" className="text-gray-600 hover:text-primary text-sm">Testimonials</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/team" className="text-gray-600 hover:text-primary text-sm">Our Team</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">© {new Date().getFullYear()} InterviewAI. All rights reserved.</p>
